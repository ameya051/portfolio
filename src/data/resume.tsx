...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        url: "https://www.linkedin.com/in/ameyashrivastava/",
        icon: Icons.linkedin,
      },
      X: {
        url: "https://x.com/ameyaidk",
        icon: Icons.x,
      },
    },
  },
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Contributed to an EdTech product within a dynamic, fast-paced team environment. Orchestrated the development of a multitude of REST APIs using Node.js and MongoDB, seamlessly integrating Google OAuth for enhanced user authentication and authorization. Proactively optimized the existing frontend by leveraging React.js and Redux Toolkit, enhancing the overall performance and user experience.",
    },
    {
      company: "Linkites Infotech",
      badges: [],
      href: "https://linkites.com",
      location: "Remote",
      title: "Fullstack Developer Intern",
      logoUrl: "/linkites.jpeg",
      start: "July 2022",
      end: "Aug 2022",
      description:
        "Spearheaded the development of a robust task-scheduling solution. Enhanced modularity with React’s component-based architecture, resulting in a more maintainable and scalable codebase. Engineered secure REST APIs using Node.js and implemented JSON Web Tokens for robust authentication, ensuring data integrity and user privacy.",
    },
  ],
  education: [
    {
      ...
      logoUrl: "/medicaps.jpeg",
      start: "2023",
      end: "2025",
    },
    {
      school: "PIMR, Indore",
      href: "https://www.pimrindore.ac.in",
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Designed a Twitter bio generator, boosting user engagement through personalized and creative bio suggestions. Currently has 10+ upvotes on producthunt.",
      technologies: [
        "Next.js",
        "Typescript",
        "Groq AI",
